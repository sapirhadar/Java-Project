...
public class DisplayCrossSectionByX implements Command 
{
	...
	public DisplayCrossSectionByX(String args) 
	{
		String[] splited=args.split(" ");
		this.index=Integer.parseInt(splited[0]);
		this.name=splited[1];
	}
	public DisplayCrossSectionByX(int index, String name) 
	{
		this.index = index;
		this.name = name;
	}
	...
	{
		Maze3dState[][] arr= MazeStock.getInstance().getMaze(name).getCrossSectionByX(index);
		String s="";
